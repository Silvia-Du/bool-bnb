<template>
  <div class="home text-center">
    <!-- jumbotron -->
    <div
      class="jumbo container-fluid px-0 mx-0 py-0 mb-0 d-none d-md-block mb-1"
    >
    ...
    >
      ...
      <div
        class="row d-flex mx-lg-5 flex-wrap justify-content-center pt-5 px-sm-2"
      >
    ...
    <div v-if="announcements === []" class="no-results container-fluid py-md-5">
      <div
        class="debug row d-flex justify-content-center align-items-center py-3"
      >
...
export default {
  ...
  methods: {
    ...
    getAnnouncement() {
      axios.get(this.announcApiUrl).then((response) => {
